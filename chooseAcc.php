...
<p style="padding:20px;" class="text-white bg-dark text-center"> Choose Account To Transfer </p><br>
        <?php 
...
<?php
                ...
                <tbody>
                    ...
                    <input name='tacc_id' type='hidden' value="<?php echo $row["Account_id"]; ?>"/>
                      ...
                      <td class='table-danger'><button type='submit' name='transfer-submit' class='btn btn-danger btn-sm'>Transfer</button></td>
                          </form>
                    </tr>
              </tbody>
   <?php         
